...
{
    public class GetListaHechosByIdQueryHandler : IRequestHandler<GetListaHechosByIdQuery, DatosHechosDto>    
    {
        private readonly IServerContext _serverContext;
        private readonly ISessionService _sessionService;


        public GetListaHechosByIdQueryHandler(IServerContext serverContext, ISessionService sessionService)
        {
            _serverContext = serverContext;
            _sessionService = sessionService;
        }

        public async Task<DatosHechosDto> Handle(GetListaHechosByIdQuery request, CancellationToken cancellationToken)
        {           

            List<Hecho> hechos = await _serverContext
                .Hechos.ToListAsync();
